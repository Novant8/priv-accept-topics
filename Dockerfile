...
WORKDIR /root/
ENTRYPOINT ["/opt/priv-accept/priv-accept.py", "--chrome_driver", "/usr/src/app/node_modules/@sitespeed.io/chromedriver/vendor/chromedriver", "--docker", "--detect_topics", "--xvfb" ]
